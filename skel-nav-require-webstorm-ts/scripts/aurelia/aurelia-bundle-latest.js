...
define('aurelia-templating/aurelia-templating',['exports', 'core-js', 'aurelia-logging', 'aurelia-metadata', 'aurelia-path', 'aurelia-loader', 'aurelia-dependency-injection', 'aurelia-binding', 'aurelia-task-queue'], function (exports, _coreJs, _aureliaLogging, _aureliaMetadata, _aureliaPath, _aureliaLoader, _aureliaDependencyInjection, _aureliaBinding, _aureliaTaskQueue) {
  ...
  var ViewFactory = (function () {
    ...
    ViewFactory.prototype.create = function create(container, executionContext) {
      var options = arguments.length <= 2 || arguments[2] === undefined ? defaultFactoryOptions : arguments[2];
      var element = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
  ...
  var ViewCompiler = (function () {
    ...
    ViewCompiler.prototype.compile = function compile(templateOrFragment, resources) {
      var options = arguments.length <= 2 || arguments[2] === undefined ? defaultCompileOptions : arguments[2];
  ...
  var HtmlBehaviorResource = (function () {
    ...
    HtmlBehaviorResource.prototype.create = function create(container) {
      var instruction = arguments.length <= 1 || arguments[1] === undefined ? defaultInstruction : arguments[1];
      var element = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
      var bindings = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
...
define('aurelia-router/aurelia-router',['exports', 'core-js', 'aurelia-logging', 'aurelia-dependency-injection', 'aurelia-route-recognizer', 'aurelia-path', 'aurelia-history', 'aurelia-event-aggregator'], function (exports, _coreJs, _aureliaLogging, _aureliaDependencyInjection, _aureliaRouteRecognizer, _aureliaPath, _aureliaHistory, _aureliaEventAggregator) {
