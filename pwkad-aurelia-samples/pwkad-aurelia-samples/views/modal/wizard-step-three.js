...
define(["require", "exports", 'aurelia-framework', './wizard'], function (require, exports, aurelia_framework_1, wizard_1) {
    var WizardStepThree = (function () {
        function WizardStepThree(wizard) {
            this.wizard = wizard;
        }
        WizardStepThree = __decorate([
            aurelia_framework_1.inject(wizard_1.Wizard)
        ], WizardStepThree);
        return WizardStepThree;
    })();
    exports.WizardStepThree = WizardStepThree;
});
//# sourceMappingURL=wizard-step-three.js.map