...
# add this back in when new release fixes problem that breaks todo app
# cp -f aurelia-bundle.js aurelia-bundle.min.js ../todo-require-vs-ts/todo-require-vs-ts/scripts/aurelia
