...
cp -f aurelia-bundle.js aurelia-bundle.min.js ../aurelia-vs-ts/aurelia-vs-ts/scripts
...
cp -f aurelia-bundle.js aurelia-bundle.min.js ../skel-nav-esri-vs-ts/skel-nav-esri-vs-ts/aurelia
