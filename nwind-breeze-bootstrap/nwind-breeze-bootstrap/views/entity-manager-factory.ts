...
export function createEntityManager() {
    ...
    entityManager = new (<any>breeze).EntityManager(settings.serviceName);
...
function logChanges(data) {
    ...
    if (data.entityAction === (<any>breeze).EntityAction.PropertyChange) {
    ...
    if (data.entityAction === (<any>breeze).EntityAction.EntityStateChange) {
